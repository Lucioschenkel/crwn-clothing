...
export const signUpFailed = (error) => createAction(USER_ACTION_TYPES.SIGN_UP_FAIL, error);
...
export const signOutFailed = (error) => createAction(USER_ACTION_TYPES.SIGN_OUT_FAIL, error);
